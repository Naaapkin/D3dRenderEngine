...
{
    D3D12CommandList* pCommandList = D3dCommandListPool::getCommandList(D3dCommandListType::COPY);
...
void D3dRenderer::registerShaders(std::vector<Shader*> shaders)
{
    for (auto& shader : shaders)
    {
        ...
        const auto& inputElems = Shader::sBuildInputElements(*shader);
...
void D3dRenderer::onRender()
{
    ...
    D3D12CommandList* pCommandList = D3dCommandListPool::getCommandList(D3dCommandListType::DIRECT);
