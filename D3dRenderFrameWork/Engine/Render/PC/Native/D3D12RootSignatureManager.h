...
{
    bool ValidateBRegister(uint8_t registerSlot) const
    {
        return registerSlot < mMaterialConstantsBase + mNumMaterialConstants;
    }

	bool ValidateTRegister(uint8_t registerSlot) const
	{
		return registerSlot < mNumTextures;
	}

    uint8_t mNumTextures;
    uint8_t mMaterialConstantsBase;
