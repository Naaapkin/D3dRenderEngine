...
inline D3D12_SRV_DIMENSION ConvertToD3D12SRVDimension(ResourceDimension dimension)
{
    switch (dimension)
    {
    ...
    case ResourceDimension::TEXTURE_CUBE:
...
inline ResourceDimension ConvertFromD3DSRVFormat(D3D_SRV_DIMENSION dimension)
{
    switch (dimension)
    {
    ...
    case D3D_SRV_DIMENSION_TEXTURECUBE:
        return ResourceDimension::TEXTURE_CUBE;
    case D3D_SRV_DIMENSION_TEXTURE1DARRAY:
        return ResourceDimension::TEXTURE1D_ARRAY;
    case D3D_SRV_DIMENSION_TEXTURE2DARRAY:
        return ResourceDimension::TEXTURE2D_ARRAY;
    default:
        WARN("Unsupported D3D SRV dimension.");
        return ResourceDimension::TEXTURE2D; // 或者定义一个 UNKNOWN 值
    }
}
