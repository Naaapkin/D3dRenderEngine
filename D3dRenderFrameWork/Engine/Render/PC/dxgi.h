...
EXTERN_C const IID IID_IDXGISwapChain;
    ...
    public:
        ...
        virtual HRESULT STDMETHODCALLTYPE GetBufferData( 
            /* [in] */ UINT Buffer,
            /* [annotation][in] */ 
            _In_  REFIID riid,
            /* [annotation][out][in] */ 
    ...
    typedef struct IDXGISwapChainVtbl
    {
        ...
        DECLSPEC_XFGVIRT(IDXGISwapChain, GetBufferData)
        HRESULT ( STDMETHODCALLTYPE *GetBufferData )( 
            IDXGISwapChain * This,
            /* [in] */ UINT Buffer,
            /* [annotation][in] */ 
            _In_  REFIID riid,
...
#define IDXGISwapChain_GetBuffer(This,Buffer,riid,ppSurface)	\
    ( (This)->lpVtbl -> GetBufferData(This,Buffer,riid,ppSurface) ) 
